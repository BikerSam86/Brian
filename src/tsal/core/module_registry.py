...
registry.register(
    ModuleMeta(
        ...
        context_tags=["entropy", "repair", "symbolic_execution", "TSAL", "coherence", "spiral"],
...
registry.register(
    ModuleMeta(
        ...
        context_tags=["logging", "symbolic_debugging", "mesh", "TSAL", "haunting"],
...
registry.register(
    ModuleMeta(
        ...
        context_tags=["chaos", "integration", "sandboxing", "entropy", "repair"],
