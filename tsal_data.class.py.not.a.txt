...
class Rev_Eng:
    ...
    def __init__(self, origin:str = None, session_id:str = None):
        ...
        self.mesh_coords = {}      # e.g., {x:..., y:..., z:..., vx:..., vy:..., vz:..., phase:..., mesh:...}
    ...
    def set_identity(self, who:str, what:str, where:str, when:Optional[str]=None, why:str=None):
        self.identity = {
            'who': who,
            'what': what,
            'where': where,
...
if __name__ == "__main__":
    ...
    rev.set_identity("RevEngKernel", "Reverse-Engineer", "Mesh_Center", why="System Audit")
    rev.log_data(4096, direction="in", updown="up")
    rev.log_data(2048, direction="out", updown="down")
    rev.update_mesh_coords(x=1, y=2, z=3, vx=0.1, vy=0.2, vz=0.3, phase="spiral", mesh="central")
